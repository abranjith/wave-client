        ...
        try {
            ...
            if (cached) {
                ...
                if (result.response.status === 401) {
                    const wwwAuth = result.response.headers['www-authenticate'] as string | undefined;
                    if (wwwAuth) {
            ...
            const wwwAuth = initialResult.response.headers['www-authenticate'] as string | undefined;
