...
import type { Collection, CollectionRequest, CollectionItem } from './types';
...
export class CollectionService extends BaseStorageService {
     ...
     * Note: Complex format transformations (Postman, HTTP, Swagger) should be handled
     * in the webview using @wave-client/core transformers before calling this method.
     * This method accepts already-transformed Wave JSON collections.
     * @param fileName The filename to save as
     ...
     * Note: For other export formats (Postman, etc.), the webview should use
     * @wave-client/core transformers to convert the collection before saving.
