...
import createArenaSlice from "./createArenaSlice"
import createRealtimeSlice from "./createRealtimeSlice"
...
type AppStateStore = 
    ...
    ReturnType<typeof createArenaSlice> &
    ReturnType<typeof createRealtimeSlice>
