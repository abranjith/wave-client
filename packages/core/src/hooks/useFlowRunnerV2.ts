...
import type { Flow, FlowRunResult, FlowNodeResult, FlowContext } from '../types/flow';
...
export interface UseFlowRunnerV2Options {
...
export interface FlowRunStateV2 {
    /** Whether the flow is currently running */
    isRunning: boolean;
    /** Current run result (or null if not started) */
    result: FlowRunResult | null;
    /** Set of currently running node IDs */
...
const DEFAULT_FLOW_RUN_STATE: FlowRunStateV2 = {
    isRunning: false,
    result: null,
 ...
 */
export function useFlowRunnerV2({
    flowId,
    environments,
    auths,
    collections,
...
export default useFlowRunnerV2;
