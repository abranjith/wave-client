...
**For detailed information on the adapter pattern, implementation examples, and migration guidelines, see:** [Design & Architecture](../docs/design.md)
...
- See [Design & Architecture](../docs/design.md) for detailed migration patterns
